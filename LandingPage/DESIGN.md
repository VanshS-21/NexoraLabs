...
colors:
  ...
  canvas-warm: "oklch(98% 0.024 95)"
  surface: "oklch(99% 0.01 70)"
  surface-tinted: "oklch(94% 0.04 82)"
...
Scene sentence: A busy owner checks the site on a phone between customer messages, then later on a laptop before booking a discovery call. The interface should feel bright, reassuring, organized, and lively enough to make custom work feel worth choosing.
...
Use a **Full palette with committed orange** strategy. Nexora Orange still carries the brand, but the page should use lime, sky, rose, and warm yellow as real spatial actors. The supporting colors create a playful studio-world rhythm, not scattered decoration.
...
- **Warm Paper Canvas**: `oklch(96% 0.03 75)`. Main page background, never pure white.
...
The page should feel paced like a guided walkthrough across a studio table, not a generic stack of sections.

- First screen: brand signal first, large type, short reassurance copy, clear navigation, and a full-bleed scatter of proof objects.
...
- Pricing: keep comparison clear, but make the cards feel like pinned proposals rather than SaaS pricing tiles.
